...
if (isset($_POST['save'])) {
    ...
    if (isset($_POST['password']) && $_POST['password'] != '') {
        Config::set('password', passwordHash($_POST['password']));
...
<form id="settings_form" method="post" action="settings.php">
    ...
    <div class="mtt-settings-table">
        ...
        <div class="tr">
            <div class="th"> <?php _e('set_title'); ?>: <div class="descr"><?php _e('set_title_descr'); ?></div>
            </div>
        ...
        <div class="tr">
            ...
            <div class="td">
                <label><input type="radio" name="allowpassword" value="1" <?php echo ((_c('password') != '') ? 'checked="checked"' : ''); ?> onclick='$(this.form).find("input[name=password]").attr("disabled",false)' /> <?php _e('set_enabled'); ?></label> <br />
                <label><input type="radio" name="allowpassword" value="0" <?php echo ((_c('password') == '') ? 'checked="checked"' : ''); ?> onclick='$(this.form).find("input[name=password]").attr("disabled","disabled")' /> <?php _e('set_disabled'); ?></label> <br />
            </div>
        </div>

        <div class="tr">
            <div class="th"><?php _e('set_newpass'); ?>: <div class="descr"><?php _e('set_newpass_descr'); ?></div>
            </div>
            <div class="td"><input type="password" name="password" autocomplete="new-password" <?php echo ((_c('password') == '') ? "disabled" : ""); ?> /> </div>
        </div>

        <div class="tr">
            <div class="th"><?php _e('set_smartsyntax'); ?>: <div class="descr"><?php _e('set_smartsyntax3_descr'); ?></div>
            </div>
            <div class="td">
                <label><input type="radio" name="smartsyntax" value="1" <?php echo ((_c('smartsyntax')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_enabled'); ?></label> <br />
                <label><input type="radio" name="smartsyntax" value="0" <?php echo ((!_c('smartsyntax')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_disabled'); ?></label>
            </div>
        </div>

        <div class="tr">
            <div class="th"><?php _e('set_autotag'); ?>: <div class="descr"><?php _e('set_autotag_descr'); ?></div>
            </div>
            <div class="td">
                <label><input type="radio" name="autotag" value="1" <?php echo ((_c('autotag')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_enabled'); ?></label> <br />
                <label><input type="radio" name="autotag" value="0" <?php echo ((!_c('autotag')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_disabled'); ?></label>
            </div>
        </div>

        <div class="tr">
            <div class="th"><?php _e('set_markdown'); ?>: <div class="descr"><?php _e('set_markdown_descr'); ?></div>
            </div>
            <div class="td">
                <label><input type="radio" name="markdown" value="1" <?php echo ((_c('markup') != 'v1') ? 'checked="checked"' : ''); ?> /> <?php _e('set_enabled'); ?></label> <br />
                <label><input type="radio" name="markdown" value="0" <?php echo ((_c('markup') == 'v1') ? 'checked="checked"' : ''); ?> /> <?php _e('set_disabled'); ?></label>
            </div>
        </div>
        ...
        <div class="tr">
            ...
            <div class="td">
                <label><input type="radio" name="showdate" value="1" <?php echo ((_c('showdate')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_enabled'); ?></label> <br>
                <label><input type="radio" name="showdate" value="0" <?php echo ((!_c('showdate')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_disabled'); ?></label> <br>
                <label><input type="checkbox" name="showdateInline" value="1" <?php echo ((_c('showdateInline')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_showdate_inline'); ?></label> <br>
                <label><input type="checkbox" name="showtime" value="1" <?php echo ((_c('showtime')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_showtime'); ?></label>
            </div>
        </div>
        ...
        <div class="tr">
            ...
            <div class="td">
                <label><input type="radio" name="exactduedate" value="1" <?php echo ((_c('exactduedate')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_enabled'); ?></label> <br />
                <label><input type="radio" name="exactduedate" value="0" <?php echo ((!_c('exactduedate')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_disabled'); ?></label>
            </div>
        </div>
        ...
        <div class="tr">
            ...
            <div class="td">
                <label><input type="radio" name="appearance" value="system" <?php echo ((_c('appearance') == 'system') ? 'checked="checked"' : ''); ?> /> <?php _e('set_appearance_system'); ?></label> <br>
                <label><input type="radio" name="appearance" value="light" <?php echo ((_c('appearance') == 'light') ? 'checked="checked"' : ''); ?> /> <?php _e('set_appearance_light'); ?></label> <br>
                <label><input type="radio" name="appearance" value="dark" <?php echo ((_c('appearance') == 'dark') ? 'checked="checked"' : ''); ?> /> <?php _e('set_appearance_dark'); ?></label>
            </div>
        </div>

        <div class="tr">
            <div class="th"><?php _e('set_newtaskcounter_h'); ?>:</div>
            <div class="td"><label><input type="checkbox" name="newTaskCounter" value="1" <?php echo ((_c('newTaskCounter')) ? 'checked="checked"' : ''); ?> /> <?php _e('set_newtaskcounter'); ?></label></div>
        </div>
