...
class MTTFilterCenter
{
    ...
    public static function addFilter(string $action, MTTFilterInterface $filter)
    {
        MTTFilterCenter::addFilterForAction($action, $filter);
    }

    public static function addFilterCallback(string $action, callable $callback)
    {
        MTTFilterCenter::addFilterCallbackForAction($action, $callback);
    }

    public static function doFilter(string $action, $in, &$out): bool
    {
