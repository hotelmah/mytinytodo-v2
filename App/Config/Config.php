...
class Config
{
    ...
    public static function dbConfigAsFileContents(): string
    {
        ...
        $a[] = "// Generated by My Tiny Todo v2\n";
        $a[] = "/*\n";
        $a[] = "  Uncomment the line with MTT_DB_TYPE if you make clean install only.\n";
        $a[] = "  Leave it commented (with # at start) if you are upgrading from version before 1.7.\n";
        $a[] = "  Select the database type: sqlite or mysql or postgres.\n";
        $a[] = "*/\n";
        $a[] = "namespace App\Config;\n";
        $a[] = "/* ===================================================================================================================== */\n";
    ...
    public static function loadDatabaseConfig()
    {
        ...
        if (!file_exists($configFile)) {
            die("My Tiny Todo v2 is not installed. Please run <a href=setup>Setup</a> first.");
        }
